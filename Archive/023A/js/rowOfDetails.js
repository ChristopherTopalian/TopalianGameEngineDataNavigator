        ...
        if(whichArray[i].tag == criteria1)
        {
            ...
            if(whichArray) //shows all items
            {
                if(whichArray[i].probability >= 50)
                {
                    ...
                    let theDiv = document.createElement("details");
                    ...
                    //BACKGROUND COLOR
                    //theDiv.style.background = "rgb(200,200,200)";
                    ...
                    //you can also set the class of the div, 
                    //to style it easier in the css section
                    theDiv.setAttribute("class", "divBackground");

                    theDiv.innerHTML += "Content Sensitive - Open at Your Discretion" + "<br>";
