...
function structuresCreate(theEvent, theX, theY)
{
    ...
    */
    ...
    // id
    ourStructure.id = structuresArray.length;
...
{
    // audioPlay("sfx_blip_001", 0.1);

    ge(activePlayer).style.backgroundColor = "rgb(100, 75, 255)"; 

    ge(activePlayer).innerHTML = "<br><br><br><br>STRUC- <br>TURE<br> MODE<br>ON";

    // ge("createButton").click();
