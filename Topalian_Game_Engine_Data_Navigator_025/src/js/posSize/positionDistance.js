...
function getDistanceX(obj1, obj2)
{
    ...
    ge('thePlayer').innerHTML = distanceX;
...
function getDistanceY(obj1, obj2)
{
    ...
    ge('thePlayer').innerHTML = distanceY;
...
function getDistanceXY(obj1, obj2)
{
    ...
    ge('thePlayer').innerHTML = '<br><br><br><br>' + obj2 + '<br>' + "X " + distanceX + "<br>" + "Y " + distanceY;
}
