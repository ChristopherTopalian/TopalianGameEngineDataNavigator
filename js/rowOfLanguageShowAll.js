...
function rowOfLanguageShowAll(theX, theY, sizeX, sizeY, whichArray, criteria1, criteria2)
{
    ...
    for(let i = 0; i < whichArray.length; i++)
    {
        if(whichArray[i].tag == criteria1 && whichArray[i].language == criteria2)
        {
            ...
            theDiv.innerHTML+= '<hr class=\'hrCompact\'><center><span style="font-size:14pt; line-height:15pt">' + whichArray[i].language + "<hr class=\'hrCompact\'>" + "<b style='color:aqua'>" + whichArray[i].category + "<b style='color:yellow'><hr class=\'hrCompact\'>" + whichArray[i].name + "</b></span></center>";
